    ...
    <section class="sidebar">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <!--li><a href="{{ url('admin.castigos') }}"><i class="fa fa-circle-o"></i> Castigos</a></li-->
            <li><a href="{{ route('admin.jugadores') }}"><i class="fa fa-circle-o"></i> Jugadores</a></li>
            <li><a href="{{ route('admin.noticias.create') }}"><i class="fa fa-circle-o"></i> Noticias</a></li>
           </ul>
        </li>
        <li>
        ...
        <!--li class="treeview">
         ...
         <li class="treeview">
          <a href="{{ url('admin/tareas/index') }}">
            <i class="fa fa-edit"></i> <span>Tareas</span>
            
          </a> 
          </li>
        <li class="treeview">
          <a href="{{ url('admin/campeonatos/campeonato') }}">
           ...
           <ul class="treeview-menu">
            <li><a href="{{ url('admin/campeonatos/partidos/index') }}"><i class="fa fa-circle-o"></i> Partidos</a></li>
            <li><a href="{{ url('admin/jugadores/Arbitros/index') }}"><i class="fa fa-circle-o"></i>Arbitros</a></li>
             </ul-->        
        </li>
        <!--li>
